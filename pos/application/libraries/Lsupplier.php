...
class Lsupplier {
    ...
    public function supplier_list() {
        ...
        $CI->load->model('Userm');
		$permission = $CI->Userm->get_permission("manage_supplier");
    ...
    public function supplier_add_form() {
        ...
        $CI->load->model('Suppliers');
        $CI->load->model('Userm');
		$permission = $CI->Userm->get_permission("add_supplier");
        $data = array(
            'title' => 'Add Supplier',
            'edited' => $permission->edited,
            'deleted' => $permission->deleted,
    ...
    public function supplier_edit_data($supplier_id) {
        ...
        $data = array(
            ...
            'tin_no' => $supplier_detail[0]['tin_no'],
            'pan_no' => $supplier_detail[0]['pan_no'],
            'cin_no' => $supplier_detail[0]['cin_no'],
            'gstin' => $supplier_detail[0]['gstin']
        );
