...
class Ccustomer extends CI_Controller {
  ...
  /*  public function insert_customer() {
    ...
    public function insertCustomer() {
        ...
        $data = array(
            ...
            'customer_address' => $this->input->post('address'),
            'attention_billing' => $this->input->post('attention_billing'),
            'country_billing' => $this->input->post('country_billing'),
            'state_billing' => $this->input->post('state_billing'),
            ...
            'attention_shipping' => $this->input->post('attention_shipping'),
            'country_shipping' => $this->input->post('country_shipping'),
            'state_shipping' => $this->input->post('state_shipping'),
            'city_shipping' => $this->input->post('city_shipping'),
            'delivery' => $this->input->post('delivery'),
  ...
  /*  public function customer_update() {
	...
	public function get_states()
	{
        ...
        $states=$this->Customers->get_states($country_id);
		$data="";
		foreach($states as $s)
		{
	...
	public function get_cities()
	{
		...
		//echo $state_id;die;
        $cities=$this->Customers->get_cities($state_id);
		$data="";
		foreach($cities as $s)
		{
			$data .= "<option value='".$s['id']."'>".$s['name']."</option>";
