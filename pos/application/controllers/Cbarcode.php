...
class Cbarcode extends CI_Controller {
	...
	public function barcode_print($product_id){
		...
		$data = array(
				...
				'price' => $product_info[0]['mrp'],
				'product_details' => $product_info[0]['product_details'],
				'product_code' => $product_code,
				'product_name_for_barcode' => $product_info[0]['product_name_for_barcode'],
			);
	...
	public function edit_barcode($product_id)
	{
		$CI =& get_instance();
		$this->auth->check_admin_auth();
		$this->load->model('Products');
        ...
        $data = array(
            ...
            'product_name_for_barcode' => $this->input->post('product_name_for_barcode'),
        );
		
		$edit_barcode= $this->Products->edit_barcode($product_id,$data);
		redirect(base_url('Cbarcode/barcode_print/'.$product_id));
	}
}
