                  ...
                  <?php echo form_open_multipart('Cweb_setting/update_setting', array('class' => 'form-vertical','id' => 'insert_customer'))?>
                    <div class="panel-body">
                       ...
                       <!-- <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="cin_no" class="col-sm-3 col-form-label">CIN NO <i class="text-danger"></i></label>
                            <div class="col-sm-6">
                                <input class="form-control" name ="cin_no" id="cin_no" type="text" placeholder="CIN NO" value="{cin_no}">
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="invoice_terms" class="col-sm-3 col-form-label">Invoice Terms <i class="text-danger"></i></label>
                            <div class="col-sm-6">
                                <textarea class="form-control" name ="invoice_terms" id="invoice_terms" type="text" placeholder="Writer terms and conditions">{invoice_terms}</textarea>
                            </div>
                        </div>
                        
                        <div class="form-group row">
                            <label for="po_terms" class="col-sm-3 col-form-label">PO Terms <i class="text-danger"></i></label>
                            <div class="col-sm-6">
                                <textarea class="form-control" name ="po_terms" id="po_terms" type="text" placeholder="Writer terms and conditions">{po_terms}</textarea>
                            </div>
                        </div>
                        
                        <div class="form-group row">
                            <label for="po_num_series" class="col-sm-3 col-form-label">PO Series <i class="text-danger"></i></label>
                            <div class="col-sm-6">
                                <input class="form-control" name ="po_num_series" id="po_num_series" type="text" value="{po_num_series}" >
                            </div>
                        </div>
                        
                        <div class="form-group row">
                            <label for="thermal_print" class="col-sm-3 col-form-label">Print Thermal Invoice</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            <label for="custom_billing" class="col-sm-3 col-form-label">Offline Billing Software</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            <label for="usr_commission" class="col-sm-3 col-form-label">Activate User Commission</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            <label for="print_kot" class="col-sm-3 col-form-label">Print KOT</label>
                            <div class="col-sm-6">
