            ...
            <div class="col-sm-12 col-md-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">  
                                <?php echo form_open('Backup_restore/process', "id='#'") ?>
                                <?php if (!$backup) { ?>
                                ...
                                <?php } else { ?>
                                    ...
                                    <a href="#" class="btn btn-success w-md m-b-5 btn-block" onclick="#" ><i class="fa fa-download"></i> <?php echo display('download') ?></a>

                                <?php } ?> 
                                <a href="#" class="btn btn-danger w-md m-b-5 btn-block" onclick="#"  ><i class="fa fa-trash"></i> <?php echo display('delete') ?></a>
                                <?php echo form_close() ?> 
                            </div>  
                        </div>  
