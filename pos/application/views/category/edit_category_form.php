                  ...
                  <?php echo form_open_multipart('Ccategory/category_update',array('class' => 'form-vertical', 'id' => 'category_update'))?>
                    <div class="panel-body">
                    	...
                    	<div class="form-group row">
                            <label for="category_name" class="col-sm-4  col-md-2  col-form-label"><?php echo display('category_name') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-8  col-md-4">
                                <input class="form-control margon_btm" name ="category_name" id="category_name" type="text" placeholder="<?php echo display('category_name') ?>"  required="" value="{category_name}" tabindex='1'>
                            </div>
                      
                            <label for="status" class="col-sm-4  col-md-2 col-form-label"><?php echo display('status') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-8  col-md-4">
                                <select class="form-control margon_btm" name="status" id="status" tabindex='2'>
