                    ...
                    <div class="panel-body">
						...
						?>
							<div style="float: center">
								...
								<a  class="btn btn-success" data-toggle="modal" data-target="#barcode_edit" ><?php echo display('edit')?></a>
								<?php
								if($product_code!="")
								{
								?>
								<a  class="btn btn-success"  onclick="show_product_barcode_detail('{product_code}','{price}','{company_name}/{product_name_for_barcode}', '', '');"><?php echo display('generate_barcode')?></a>
								<?php
					         	}
						       ?>
							</div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><?php echo display('edit_barcode') ?></h4>
        </div>
		   ...
		   <div class="row">
				<div class="col-sm-12">
					<div class="form-group row">
						<label for="company_name" class="col-sm-4 col-form-label"><?php echo display('company_name_label') ?></label>
						<div class="col-sm-8">
			...
			<div class="row">
				<div class="col-sm-12">
				   <div class="form-group row">
						<label for="product_code" class="col-sm-4 col-form-label"><?php echo display('product_name_for_barcode') ?></label>
						<div class="col-sm-8">
			...
			<div class="row">
				<div class="col-sm-12">
				   <div class="form-group row">
						<label for="product_code" class="col-sm-4 col-form-label"><?php echo display('product_code') ?></label>
						<div class="col-sm-8">
							<input class="form-control" name="product_code" id="product_code" rows="3" placeholder="Product Code" value={product_code} />
							 <i class="text-danger" id="code_exist" hidden><?php echo display('code_already_exist') ?></i>
						</div>
					</div> 
				</div>
			</div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header pro_bar">
                        <h4 class="modal-title"><?php echo display('product_barcode') ?></h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                        ...
                        <div id="barcode_div" style="">                            
                            <div class="form_bar"> 
                                ...
                                <div class="col-md-12 col-sm-12"> 
                                    <label> <?php echo display('left_label') ?> : </label><input class="form-control" type="text" id="barcode_lable_input_1" value="" maxlength="20">
                                    <label> <?php echo display('right_label') ?>  : </label><input class="form-control" type="text" id="barcode_lable_input_2" value="" maxlength="20">
                                    <label> <?php echo display('barcode_print_count') ?> : </label><input class="form-control" type="number" id="barcode_print_count" value="1" min="1" max="100">
                                    <label> <?php echo display('barcode_print_in_row') ?> : </label>
                                    <div class="br_redio">
                                   ...
                                   <input class="" type="radio" name="barcode_print_count" value="2" checked="">2
                                    ...
                                    <a class="submit_btnn  btn-warning con_btn_bar" style="cursor:pointer" onclick="confirm_product_barcode_detail();"><?php echo display('confirm') ?></a>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 bar_codes" id="single_barcode_print_div" style="display:none;margin-top:80px;">
                                ...
                                <a class=" btn-primary br_print" style="cursor:pointer" onclick="print_barcode();"><?php echo display('print') ?></a>
                            </div>
                        </div>
