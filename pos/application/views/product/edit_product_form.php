                                        ...
                                        <td class="text-right" style="width:10%">
                                            ...
                                            <div class="chk-all">
														...
														<?php foreach($uom_list as $uom) { 
															if($uom['uom_id']==$uom_selected){
															$uom_name= $uom['uom_name'];
															}
															} ?>
															 <input type="text" id="uom_name" data-toggle="modal" data-target="#today_act_modal" placeholder="Select One" class="form-control input_type" value="<?php echo $uom_name;?>">
															 <!--i class="fa fa-angle-down"></i-->
															 <input type="text" name="uom" id="uom" value="<?php echo $uom_selected;?>" hidden >
														</div>
													</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
			...
			<select id="select_uom" onchange="get_uom();" class="form-control"  style="width:100%">
				<?php foreach($uom_list as $uom) { ?>
				<option value="<?php echo $uom['uom_id']; ?>" <?php if($uom['uom_id']==$uom_selected): echo "selected";endif;?>><?php echo $uom['uom_name'];?> </option>
				<?php } ?>
			</select>
