...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('manage_rol_product') ?></h1>
            <small><?php echo display('manage_your_product') ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('product') ?></a></li>
                <li class="active"><?php echo display('manage_rol_product') ?></li>
            </ol>
        </div>
    </section>
                            ...
                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:5%"><?php echo display('product') ?></th>
                                        <th style="width:5%"><?php echo display('model') ?></th>
                                        <th style="width:5%"><?php echo display('uom') ?></th>
                                        <th style="width:5%"><?php echo display('Qty') ?></th>
                                        <th style="width:5%"><?php echo display('rol') ?></th>
                                        <th style="width:5%"><?php echo display('supplier') ?></th>
                                        ...
                                        <th style="width:30%"><?php echo display('action') ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    if ($products_list) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: right;">
                                                <?php echo (($position == 0) ? "CGST-{cgst}% SGST-{sgst}% IGST-{igst}% UTGST-{utgst}%" : "CGST-{cgst}% SGST-{sgst}% IGST-{igst} UTGST-{utgst}%") ?>
                                            </td>
                                            <td style="text-align: right;">
