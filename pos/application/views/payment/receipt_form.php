...
//                                    foreach ($trans_category as $values) {
                        ...
                        <div class="form-group row">
                            <!--label for="Transection_mood" class="col-sm-4 col-md-2 col-form-label"><--?php echo display('transaction_mood') ?></label-->
                                <label for="Transection_mood" class="col-sm-4 col-md-2 col-form-label"><?php echo display('transaction_moad') ?></label>
                            <div class="col-sm-8  col-md-4 margon_btm">
                            ...
                            <div class="" id="PaymentContainer2">
                                <label for="receipt" class="col-sm-4  col-md-2 col-form-label"><?php echo display('receipt_amount') ?></label>
                                <div class="col-sm-8  col-md-4">
                                    <input class="none form-control " name ="amount" id="receipt" class="none" type="number" placeholder="<?php echo display('receipt_amount') ?>" tabindex='7'>
                                </div>
                            </div>
                        </div>
