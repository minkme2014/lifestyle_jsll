                                ...
                                <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        if ($stok_report) {
                                            ...
                                            <tr>
                                                <td>{date}</td>
                                                <td align="center">
                                                    <a href="<?php echo base_url() . 'Cproduct/product_details/{product_id}'; ?>">{product_model}</a>	
                                                </td>
                                                ...
                                                <td>{totalSalesQnty}</td>
                                                <td><?php echo (($position == 0) ? "$currency {in_taka}" : "{in_taka} $currency") ?></td>
                                                <td><?php echo (($position == 0) ? "$currency {out_taka}" : "{out_taka} $currency") ?></td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td><b>{SubTotalinQnty}</b></td>

                                            <td><b>{SubTotaloutQnty}</b></td>
