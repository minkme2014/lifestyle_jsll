...
<div class="content-wrapper">
	<section class="content-header">
	    ...
	    <div class="header-title">
	        <h1><?php echo display('invoice_return_report') ?></h1>
	        <small><?php echo display('invoice_return_report') ?></small>
	        <ol class="breadcrumb">
	            <li><a href="index.html"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
	            <li><a href="#"><?php echo display('report') ?></a></li>
	            <li class="active"><?php echo display('invoice_return_report') ?></li>
	        </ol>
	    </div>
	</section>
			...
			<div class="col-sm-12">
		        <div class="panel panel-default">
		            <div class="panel-body"> 
		                <?php echo form_open('Admin_dashboard/invoice_return_report',array('class' => 'form-inline'))?>
		        ...
		        <div class="panel panel-bd lobidrag">
		            <div class="panel-heading">
		                <div class="panel-title">
		                    <h4><?php echo display('invoice_return_report') ?> </h4>
		                </div>
		            </div>
		            <div class="panel-body">
		                    ...
		                    <table id="dataTableExample3" class="table table-bordered table-striped table-hover">
		                        <thead>
		                            <tr>
                                        ...
                                        <th><?php echo display('Carton/Qty') ?></th-->
		                        ...
		                        <tbody>
		                        <?php
		                        	if ($invoice_return_report) 
										//print_r($invoice_return_report);
										$i=1;
										foreach($invoice_return_report as $sr)
										{
											?>
									...
									<tr>
										...
										<!--td><?php echo $sr['cartoon'];?></td>
										<td><?php echo $sr['quantity']/$sr['cartoon'];?></td-->
										<td><?php echo $sr['quantity'];?></td>
										<td><?php echo $sr['total_price']-$sr['this_discount']+$sr['this_tax'];?></td>
