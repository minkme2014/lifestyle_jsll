                    ...
                    <div class="panel panel-bd">
                      ...
                      <!--   <?php echo form_open_multipart('Admin_dashboard/change_password',array('id' => 'insert_product','class' => 'form-horizontal'))?>-->
                            ...
                            <div class="panel-footer text-center">
                                <div class="login-btn">
                                    <button type="submit" id="btn-submit" class="btn btn-success btn-block m-b-10"><i class="fa fa-play-circle"></i> <?php echo display('change_password') ?></button>
                                </div>             
                            </div>
                        <?php// echo form_close()?>
                    </div>
...
$(document).ready(function(){
	$("#btn-submit").click(function(){
		...
		var repassword = $("#repassword").val();
			$.ajax({
					url:'<?php echo site_url('Admin_dashboard/change_password'); ?>',
					data: {'email':email,'old_password':old_password,'password':password,'repassword':repassword},
					type:'POST',
					success: function(result)
					{
						...
						{
							$.ajax({	
								url:'https://<?php echo $_SERVER['SERVER_NAME']?>/billing/change_user_password.php',
