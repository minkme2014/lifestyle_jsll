                            ...
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                <tbody id="addinvoiceItem">
                                    <tr>
                                        ...
                                        <td style="width: 10%">
                                            <input type="text" name="uom[]" class="form-control text-right uom_1" value="" readonly="" style="width:50px;"/>
                                        </td>
                                        <td style="width: 14%">
                                       ...
                                       <!-- tax -->
                                        <td class="text-center" width="16%">
                                            <label class="switch">
											  ...
											  CGST-<input type="text" id="cgst_1" class="cgst_1" name="cgst[]" onkeyup="quantity_calculate(1);"  onchange="quantity_calculate(1);" style="width:20px;border:none;">
											  SGST-<input type="text" id="sgst_1" class="sgst_1" name="sgst[]" onkeyup="quantity_calculate(1);"  onchange="quantity_calculate(1);" style="width:20px;border:none;">
											  IGST-<input type="text" id="igst_1" class="igst_1" name="igst[]" onkeyup="quantity_calculate(1);"  onchange="quantity_calculate(1);" style="width:20px;border:none;">
											  UTGST-<input type="text" id="utgst_1" class="utgst_1" name="utgst[]" onkeyup="quantity_calculate(1);"  onchange="quantity_calculate(1);" style="width:20px;border:none;">
                                        </td>
...
function addnewInputField(t) {
    if (count == limits) alert("You have reached the limit of adding " + count + " inputs");
		...
		"IGST-<input type='text' id='igst_" + count + "' class='igst_" + count + "' name='igst[]' onkeyup='quantity_calculate(" + count + ");' onchange='quantity_calculate(" + count + ")' style='width:20px;border:none;'>"+
		"UTGST-<input type='text' id='utgst_" + count + "' class='utgst_" + count + "' name='utgst[]' onkeyup='quantity_calculate(" + count + ");' onchange='quantity_calculate(" + count + ")' style='width:20px;border:none;'></td>"+
        "<td class='text-right'>"+
