	                    ...
	                    <div class="panel-body overflow_scroll">
	                        ...
	                        <div class="table-responsive m-b-20">
									 ...
									 style="width: 60px; height: 60px;">
                                                  ...
                                                  <br>
                                                <b> <?php echo display('company_details') ?> :</b>
                                                {company_name}
                                                {address}<br>
                                                <b><?php echo display('mobile') ?>:</b>  {mobile}<br>
                                                <b><?php echo display('email') ?>:</b> {email}<br>
                                                <b><?php echo display('website') ?>:</b> {website}
                                              </td>
	                                        {/company_info}
                                              <td style="width: 33%;" rowspan=3 >
                                                <b><?php echo display('customer_name') ?>: </b>
                                                {customer_name}<br>
                                                <?php if ($customer_email) {?>
                                                <b><?php echo display('customer_email') ?>:</b> {customer_email}<br>
                                                 <?php } ?>
                                                <?php if ($customer_mobile) { ?>
                                                <b><?php echo display('customer_mobile') ?>:</b> {customer_mobile}<br>
                                                <?php } ?>
                                                 <b><?php echo display('customer_address') ?>:</b><?php if ($customer_address) { ?>
		                                {customer_address}
		                                <?php } ?><br>
                                              </td>
                                              <td>
                                                <b><?php echo display('billing_date') ?>:</b> {final_date}
                                              </td>
                                            </tr>
                                            <tr>
                                               
                                              <td valign=middle>
                                            <b><?php echo display('document_no_CSP/HK/SOP') ?>:</b>
                                              </td>
                                            </tr>
                                              <tr>
                                               
                                              <td valign=middle>
                                            <b><?php echo display('CIN_Number') ?> : </b><?php if (isset($Web_settings[0]['cin_no'])) {echo  $Web_settings[0]['cin_no'] ; }?>
                                              </td>
                                            </tr>
                                          </table>
	                                ...
	                                <thead>
	                                    <tr>
	                                        <th align="center"><?php echo display('S_No') ?> </th>
	                                        <th align="center"><?php echo display('title/content') ?></th>
	                            ...
	                            <table style="margin: 0;"  border=1  class="table table-striped table-bordered">
                                            ...
                                            <tr>
                                              ...
                                              <td style="width: 37%;"><b><?php echo display('approved_by') ?> :- </b><?php echo $this->session->userdata('user_name');?></td>
                                              <td style="width: 33%;" rowspan=3 ><b><?php echo display('standard_operating_products') ?></b></td>
                                              <td> <b><?php echo display('receiver_name') ?> :-</b> </td>
                                            </tr>
                                            <tr>
                                                <td> <b><?php echo display('issued_by') ?> :-  </b><?php echo $this->session->userdata('user_name');?></td>
                                              <td valign=middle><b><?php echo display('receipt_no') ?> :- </b> {invoice_id}</td>
                                             
                                            </tr>
                                             <tr>
                                                <td> <b><?php echo display('issued_date') ?> :- </b><?php echo date("d/m/Y");?> </td>
                                              <td valign=middle>
                                            <b><?php echo display('receiver_date') ?> :-</b></td>
