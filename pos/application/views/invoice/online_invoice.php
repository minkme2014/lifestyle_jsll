...
<div class="content-wrapper">
	<section class="content-header">
	    ...
	    <div class="header-title">
	        ...
	        <h1><?php echo display('manage_online_invoice') ?></h1>
	        <small><?php echo display('manage_your_invoice') ?></small>
             ...
             <div class="col-md-6 col-sm-6">
    	        <ol class="breadcrumb">
    	            ...
    	            <li class="active"><?php echo display('manage_online_invoice') ?></li>
    	        </ol>
             </div>
	    </div>
	</section>
		                    ...
		                    <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
								...
								{invoices_list}
									<tr>
										<td>{sl}</td>
										<td>
											<a href="<?php echo base_url().'Cinvoice/online_invoice_inserted_data/{invoice_id}'; ?>">
											{invoice}
											</a>
										</td>
										<td>
										...
										<td class="display_flx">
												...
												<?php echo form_open()?>
													...
													<a href="<?php echo base_url().'Cinvoice/online_invoice_inserted_data/{invoice_id}'; ?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('invoice') ?>"><i class="fa fa-window-restore" aria-hidden="true"></i></a>
													...
													<a href="<?php echo base_url().'Cinvoice/invoice_challan/{invoice_id}'; ?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" title="Challan"><i class="fa fa-file-o" aria-hidden="true"></i></a-->
												<?php echo form_close()?>
