...
<div class="content-wrapper">
    ...
    <section class="content">
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td valign='top' style='color:#404041;font-size:12px;padding:0px 5px 0px 5px'>
                                                                                                {company_info}
                                                                                                <address   class="abbr_tg" style="margin-top:10px">
                                                                                ...
                                                                                <table width='570' border='0' cellspacing='0' cellpadding='0'>
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td width='85' align='right' style='color:#404041;font-size:12px;line-height:16px;border-bottom:solid 1px #e5e5e5'>
                                                                                                <strong><?php echo display('uom') ?></strong>
                                                                                            </td>
        ...
        <div class="row" width="40%" style="display:none">
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div id="printableArea">
                        ...
                        {company_info}
							<address style="margin-top:10px; font-size:8px">
								<strong>{company_name}</strong><br>
								{address}<br>
								<abbr><?php echo display('mobile') ?>:</abbr> {mobile}<br>
								<abbr><?php echo display('email') ?>:</abbr> 
							...
							<address   class="abbr_tg" style="font-size:8px">  
								<strong>{customer_name} </strong><br>
								<abbr><?php echo display('address') ?>:</abbr>
								<?php
								if ($customer_address) {
							...
							<table width='' border='1' cellspacing='0' cellpadding='0'>
								<tbody>
									<tr>
										...
										<td width='' align='center' style='color:#404041; font-size:7px'>
											<strong><?php echo display('sl') ?></strong>
										</td>
									...
									{invoice_all_data}
									<tr>
										<td width='' align='center' valign='top' style='color:#404041;font-size:7px;'>
											{sl}
										</td>
										<td width='' align='center' valign='top' style='color:#404041;font-size:7px;'>
											{product_name} - ({product_model})
							...
							<tbody>
								<tr>
									<td width='0' align='left' valign='top' style='color:#404041;font-size:8px;'>
										<strong><?php echo display('total_discount') ?></strong> 
									</td>
									<td width='0' align='right' valign='top' style='color:#404041;font-size:8px;'>
										<?php echo (($position == 0) ? "$currency {total_discount}" : "{total_discount} $currency") ?>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td align='left' valign='top' style='color:#404041;font-size:8px;'>
										<strong><?php echo display('grand_total') ?>:</strong>
									</td>
									<td width='62' align='right' valign='top' style='color:#404041;font-size:8px;'>
										<?php echo (($position == 0) ? "$currency {total_amount}" : "{total_amount} $currency") ?>
									</td>
								</tr>
								...
								<tr>
									<td align='left' valign='bottom' style='color:#404041;font-size:8px;'>
										<strong><?php echo display('due') ?> :</strong>
									</td>
									<td width='62' align='right' valign='bottom' style='color:#339933;font-size:8px;'>
										<strong><?php echo (($position == 0) ? "$currency {due_amount}" : "{due_amount} $currency") ?></strong>
									</td>
								</tr>
							</tbody>
