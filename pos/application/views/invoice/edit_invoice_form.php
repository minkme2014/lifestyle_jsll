                            ...
                            <table class="table table-bordered table-hover">
								...
								<?php foreach($invoice_all_data as $invoice){?>
									<tr>
                                        ...
                                        <td>
                                            <input type="text" name="uom[]" class="uom_<?php echo $invoice['sl']?> form-control text-right" value="<?php echo $invoice['uom_name']?>" style='width:100px;    text-align: left;'  readonly />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" onkeyup="quantity_calculate_per(<?php echo $invoice['sl']?>);"  onchange="quantity_calculate_per(<?php echo $invoice['sl']?>);" id="discount_per_<?php echo $invoice['sl']?>" class="form-control text-right" placeholder="<?php echo display('discount')?>" value="<?php 
											if($invoice['this_discount']!==0 || $invoice['this_discount']!="")
											{ 
												$dis_per=$invoice['this_discount']*100/$invoice['total_price'];
												echo $dis_per;
											} ?>" min="0" tabindex="6"/>
                                        </td>
                                       <!-- tax -->
