...
<div class="content-wrapper">
	<section class="content-header">
	    ...
	    <div class="header-title">
	        <h1><?php echo display('sales_record') ?></h1>
	        <small><?php echo display('sales_record') ?></small>
	        <ol class="breadcrumb">
	            <li><a href="index.html"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
	            <li><a href="#"><?php echo display('invoice') ?></a></li>
	            <li class="active"><?php echo display('sales_record') ?></li>
	        </ol>
	    </div>
	</section>
			...
			<div class="col-sm-12">
		        <div class="panel panel-default">
		            <div class="panel-body"> 
		                <?php echo form_open('Cinvoice/sales_record',array('class' => 'form-inline'))?>
		        ...
		        <div class="panel panel-bd lobidrag">
		            <div class="panel-heading">
		                <div class="panel-title">
		                    <h4><?php echo display('sales_record') ?> </h4>
		                </div>
		            </div>
		            <div class="panel-body">
		                    ...
		                    <table id="dataTableExample3" class="table table-bordered table-striped table-hover">
								...
								//$i=1;
									...
									<tr>
										...
										<td>SKU</td>
										<td><input type="text" id="placement_<?php echo $sr['invoice'];?>"></td>
										<td><input type="text" id="influence_<?php echo $sr['invoice'];?>"></td>
										...
										<td><input type="text" id="bank_charges_per_<?php echo $sr['invoice'];?>"></td>
										<td><input type="text" id="bank_charges_<?php echo $sr['invoice'];?>"></td>
										<td><input type="text" class="form-control datepicker" id="shipping_date_<?php echo $sr['invoice'];?>" placeholder="<?php echo display('shipping_date') ?>" ></td>
										<td><input type="text" id="shipping_through_<?php echo $sr['invoice'];?>"></td>
										<td><input type="text" id="weight_<?php echo $sr['invoice'];?>"></td>
										<td><?php echo $sr['delivery_charges'];?></td>
										<td><?php echo $sr['packaging'];?></td>
										<td><?php echo $sr['freight_charges'];?></td>
										<td><input type="text" class="form-control datepicker" id="delivery_date_<?php echo $sr['invoice'];?>" placeholder="<?php echo display('delivery_date') ?>" ></td>
										<td><input type="text" id="feedback_<?php echo $sr['invoice'];?>"></td>
										<td><input type="button" value="add" class="btn-primary" onclick="add('<?php echo $sr['invoice'];?>')"></td>
