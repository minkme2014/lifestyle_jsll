                            ...
                            <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo display('billing_address'); ?></th>
                                        <th><?php echo display('delivery_address'); ?></th>
...
//                                    print_r($customers_list); //die();
		...
		(SELECT sum(amount) FROM customer_ledger WHERE d_c = "c" AND customer_id = "' . $single['customer_id'] . '") cr';
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $single['bill']; ?></td>
                                                <td><?php echo $single['delivery']; ?></td>
                                        ...
                                        <center>
											...
											if($this->session->userdata('user_type')!=1) 
											{
												if($edited)
												{
													if($edited!==0)
													{?>
														<a href="<?php echo base_url() . 'Ccustomer/customer_update_form/'.$single['customer_id']; ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('update') ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
											...
											if($this->session->userdata('user_type')!=1) 
											{
												if($deleted)
												{
													if($deleted!==0)
													{?>
														<a href="" class="deleteCustomer btn btn-danger btn-sm" name="<?php echo $single['customer_id']; ?>" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
