    ...
    <section class="content">
        ...
        <div class="row">
			...
			<div style="border: 1px solid #000;">
                <h4 class="headinh_h" style='text-align: center;'>SERVICE PURCHASE ORDER</h4>
                <table border="1" cellpadding="4" class="table table_main">
                    <tbody>
                        <div class="" style='display: flex;'>
                        	<ul class="col-md-6 ul_list_none"  style='    width: 50%; list-style-type: none;'>
                    	    <li><b><?php echo display('po_no');?> : </b><span> {po_no}</span></li>
                    	    <li><b><?php echo display('TIN/CST_number');?> : </b><span>{sup_tin_no}</span></li>
                    	    <li><b><?php echo display('CIN_number');?> : </b><span>{sup_cin_no}</span></li>
                    	    
                    	</ul>
                    	<ul class="col-md-6 ul_list_none "  style='    width: 50%; list-style-type: none;'>
                    	    <li><b><?php echo display('po_date');?> : </b><span>{po_date}</span></li>
                    	    <li><b><?php echo display('PAN_number');?> : </b><span>{sup_pan_no}</span></li>
                    	    <li><b><?php echo display('GSTIN');?> : </b><span>{sup_gstin}</span></li>
                    	</ul>
                   </div>
                </table>
				</div>
			<div style="border: 1px solid #000;">
                ...
                <table border="1" cellpadding="4" class="table table_main">
                    <tbody>
                    	...
                    	<ul class="col-md-6 ul_list_none "  style='    width: 50%; list-style-type: none;'>
                    	    <li><b><?php echo display('payment_terms');?> : </b><span> {payment_terms}</span></li>
                    	    <li><b><?php echo display(currency);?> : </b><span> <?php echo $Web_settings[0]['currency'];?></span></li>
                ...
                <!--<table border="1" cellpadding="4" class="table table_main">
                    ...
                    <td bgcolor="" rowspan="3"> <strong><?php echo display('delivery_address');?> : </strong>{delivery_address}<br>
						...
						<ul class="col-md-6 ul_list_none "  style='    width: 50%; list-style-type: none;'>
                    	    ...
                    	    <?php if($delivery_address){?><li><b><?php echo display('delivery_address');?> : </b><span>{delivery_address}</span></li><?php } ?>
