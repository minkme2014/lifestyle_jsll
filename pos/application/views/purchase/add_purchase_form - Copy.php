                            ...
                            <table class="table table-bordered table-hover" id="purchaseTable">
                                ...
                                <tbody id="addPurchaseItem">
                                    <tr>
                                        ...
                                        <td width="10%">
                                            <input type="text" class="form-control text-right uom_1" name="uom[]" placeholder="UOM"  readonly="readonly" />
                                        </td>
                                ...
                                <tbody id="form-actions">
                                    <tr class="">
                                        ...
                                        <td class="" style="width:10%">
                                            <input class="form-control text-right" name="mrp" id="mrp" type="number" step="0.01" placeholder="<?php echo display('mrp') ?>" tabindex="7" min="0">
                                        </td> 
                                        <td class="" style="width:10%">
                                            <input class="form-control text-right" name="price" id="price2" type="number" step="0.01" placeholder="<?php echo display('sell_price') ?>" tabindex="8" min="0">
                                        </td>
                                        <td class="" style="width:10%">
                                            <input type="number" tabindex="9" id="prd_price" class="form-control text-right" onkeyup="prd_cal_total();" onblur="prd_cal_total();" name="supplier_price" step="0.01" placeholder="Purchase Price "  required  min="0"/>
                                        </td>
                                        ...
                                        <td class="text-right" style="width:14%">
                                            <input type="number" tabindex="12" class="form-control" id="prd_cgst" name="prd_cgst" step="0.01" onkeyup="prd_cal_total();" onblur="prd_cal_total();" placeholder="<?php echo display('cgst') ?>" style="width:31%; display:inline;padding:0;"/>
											<input type="number" tabindex="13" class="form-control" id="prd_sgst" name="prd_sgst" step="0.01" onkeyup="prd_cal_total();" onblur="prd_cal_total();" placeholder="<?php echo display('sgst') ?>" style="width:31%; display:inline;padding:0;" />
											<input type="number" tabindex="14" class="form-control" id="prd_igst" name="prd_igst" step="0.01" onkeyup="prd_cal_total();" onblur="prd_cal_total();" placeholder="<?php echo display('igst') ?>" style="width:31%; display:inline;padding:0;" />
											<input type="number" tabindex="14" class="form-control" id="prd_utgst" name="prd_utgst" step="0.01" onkeyup="prd_cal_total();" onblur="prd_cal_total();" placeholder="<?php echo display('utgst') ?>" style="width:31%; display:inline;padding:0;" />
                                        </td>
                                        <td class="text-right" style="width:15%">
                                            <input type="number" tabindex="15" class="form-control" id="prd_total" name="total" placeholder="<?php echo display('total') ?>" step="0.01" required />
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
