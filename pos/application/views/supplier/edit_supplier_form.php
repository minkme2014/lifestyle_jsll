                   ...
                   <?php echo form_open_multipart('Csupplier/supplier_update',array( 'id' => 'supplier_update'))?>
                    <div class="panel-body">
                    	...
                    	<div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control margon_btm" name ="supplier_name" id="supplier_name" type="text" value="{supplier_name}" placeholder="<?php echo display('supplier_name') ?>"  required="" tabindex='1'>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control margon_btm" name="address" id="address " rows="3" placeholder="<?php echo display('supplier_address') ?>"  tabindex='3'>{address}</textarea>
                            </div>
                        ...
                        <div class="form-group row">
                            <!--label for="address " class="col-sm-3 col-form-label"><--?php echo display('supplier_address') ?></label-->
                            <div class="col-sm-6">
                                <input class="form-control" name="tin_no" id="tin_no " rows="3" placeholder="<?php echo display('TIN/CST_number') ?>" tabindex="3" value="{tin_no}" >
                            </div>
                                <!--label for="details" class="col-sm-3 col-form-label"><--?php echo display('supplier_details') ?></label-->
                            <div class="col-sm-6">
                                <input class="form-control" name="pan_no" id="pan_no" rows="3" placeholder="<?php echo display('PAN_number') ?>" tabindex="4" value="{pan_no}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <!--label for="address " class="col-sm-3 col-form-label"><--?php echo display('supplier_address') ?></label-->
                            <div class="col-sm-6">
                                <input class="form-control" name="cin_no" id="cin_no " rows="3" placeholder="<?php echo display('CIN_number') ?>" tabindex="3" value="{cin_no}" >
                            </div>
                                <!--label for="details" class="col-sm-3 col-form-label"><--?php echo display('supplier_details') ?></label-->
                            <div class="col-sm-6">
                                <input class="form-control" name="gstin" id="gstin" rows="3" placeholder="<?php echo display('GSTIN') ?>" tabindex="4" value="{gstin}" >
                            </div>
                        </div>
