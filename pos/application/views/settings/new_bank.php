                ...
                <div class="panel panel-bd lobidrag">
                   ...
                   <?php echo form_open_multipart('Csettings/add_new_bank',array('class' => 'form-vertical','id' => 'insert_deposit' ))?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <label for="ac_name" class="col-sm-3  col-md-3 col-form-label"><?php echo display('ac_name') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-9  col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="ac_no" class="col-sm-3  col-md-3 col-form-label"><?php echo display('ac_no') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-9 col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="branch" class="col-sm-3  col-md-3 col-form-label"><?php echo display('branch') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-9 col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="signature_pic" class="col-sm-3  col-md-3 col-form-label"><?php echo display('signature_pic') ?> <i class="text-danger"></i></label>
                            <div class="col-sm-9 col-md-6">
