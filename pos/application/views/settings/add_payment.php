                   ...
                   <?php echo form_open_multipart('Csettings/submit_payment',array('class' => 'form-vertical','id' => 'inflow_entry' ))?>
                    <div class="panel-body">
                    	...
                    	<div class="form-group row">
                            <label for="name" class="col-sm-3  col-md-3 col-form-label"><?php echo display('name') ?> <i class="text-danger">*</i></label>
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-sm-3  col-md-3 col-form-label"><?php echo display('phone') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-9 col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="details" class="col-sm-3  col-md-3 col-form-label"><?php echo display('details') ?> <i class="text-danger"></i></label>
                            <div class="col-sm-9 col-md-6">
