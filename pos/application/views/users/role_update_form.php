        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('User/update_role', array('class' => 'form-vertical',)) ?>
                    <div class="panel-body">

                        <div class="form-group row">
                            <label for="role" class="col-sm-3  col-md-3 col-form-label"><?php echo display('role') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-9 col-md-6">
                                <input type="text" class="form-control" name="role" id="role" value="<?php echo $role_name; ?>" required />
                                <input type="hidden" class="form-control" name="role_id" id="role_id" value="<?php echo $role_id; ?>" required />
                            </div>
                        </div>
