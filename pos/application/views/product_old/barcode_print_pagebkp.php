                    ...
                    <div class="panel-body">
						...
						?>
							<div style="float: center">
								...
								{
								?>
								<a  class="btn btn-success"  onclick="show_product_barcode_detail('{product_code}','{company_name}/{product_name_for_barcode}', '', '');">Generate Barcode</a>
								<?php
					         	}
						       ?>
							</div>
                                ...
                                <div style="width: 380px; height: 90px; overflow: hidden; max-height: 90px; margin-top: -2px;">
                                    <div  style="width: 48%; float: left;" class="image_code">
                                        <div style="overflow: hidden; width: 100%; margin: 0 auto;"  class="main_bar_txt"> 
                                            ...
                                            <span style="width: 44%; display: inline-block; white-space: nowrap; overflow: hidden !important; text-overflow: ellipsis; font-size: 9px;    text-align: center;" class="title_res"><?php echo $this->session->userdata('user_name') ?></span>
                                        </div> 
